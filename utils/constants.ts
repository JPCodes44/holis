...
export const poolBalance = new Web3.PublicKey(
    "CxhR7oayUpzAHQyPTXVN5zpbtzeXj46Y7CDi9AyFncrp"
)
...
export const kryptUserAccount = new Web3.PublicKey(
    "3P9ichFctMX9RoSfeRQcYRXvUUsfvqN5Vrhkguj3KPY9"
)

export const scroogeUserAccount = new Web3.PublicKey(
    "DSy9cHje3zhctv89LUKzJijWSJnuknf6G2rrbBM8Xf7L"
)
